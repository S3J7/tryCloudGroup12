...
import com.trycloud.pages.ContactsMenuPage;
...
//Siri
    ...
    public void userClickTheContactButton() {
        ...
        basePage.contactMenuBtn.click();
    }

    @When("User click on new contact button")
    public void userClickOnNewContactButton() {

       ContactsMenuPage contactsMenuPage = new ContactsMenuPage();
        contactsMenuPage.newContactBtn.click();
